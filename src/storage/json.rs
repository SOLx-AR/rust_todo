...
mod tests {
    ...
    fn test_guardar_y_cargar_json() {
        ...
        let tareas_originales = vec![
            Tarea { descripcion: "Tarea JSON 1".to_string(), completada: false, ultimo_cambio: None },
            Tarea { descripcion: "Tarea JSON 2".to_string(), completada: true, ultimo_cambio: Some(chrono::Utc::now()) },
        ];
